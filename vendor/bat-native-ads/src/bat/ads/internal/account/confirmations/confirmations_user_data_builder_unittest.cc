...
TEST_F(BatAdsConfirmationUserDataTest, BuildForNonConversionConfirmationType) {
  ...
  user_data_builder.Build([](const base::Value& user_data) {
    ...
    const std::string pattern =
        R"~({"buildChannel":"release","catalog":\[{"id":"29e5c8bc0ba319069980bb390d8e8f9b58c05a20"}],"countryCode":"US","createdAtTimestamp":"2020-11-18T12:00:00.000Z","mutated":true,"odyssey":"host","platform":"windows","rotating_hash":"3063771545","studies":\[],"systemTimestamp":"2020-11-18T12:00:00.000Z","versionNumber":"\d{1,}\.\d{1,}\.\d{1,}\.\d{1,}"})~";
