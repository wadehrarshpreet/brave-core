...
#ifndef BRAVE_VENDOR_BAT_NATIVE_ADS_SRC_BAT_ADS_INTERNAL_FEDERATED_COVARIATES_AD_NOTIFICATION_CLICKED_H_
#define BRAVE_VENDOR_BAT_NATIVE_ADS_SRC_BAT_ADS_INTERNAL_FEDERATED_COVARIATES_AD_NOTIFICATION_CLICKED_H_
...
class AdNotificationClicked final : public Covariate {
 public:
...
#endif  // BRAVE_VENDOR_BAT_NATIVE_ADS_SRC_BAT_ADS_INTERNAL_FEDERATED_COVARIATES_AD_NOTIFICATION_CLICKED_H_
