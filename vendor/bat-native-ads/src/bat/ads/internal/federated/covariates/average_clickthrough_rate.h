...
#ifndef BRAVE_VENDOR_BAT_NATIVE_ADS_SRC_BAT_ADS_INTERNAL_FEDERATED_COVARIATES_AVERAGE_CLICKTHROUGH_RATE_H_
#define BRAVE_VENDOR_BAT_NATIVE_ADS_SRC_BAT_ADS_INTERNAL_FEDERATED_COVARIATES_AVERAGE_CLICKTHROUGH_RATE_H_
...
class AverageClickthroughRate final : public Covariate {
 public:
...
#endif  // BRAVE_VENDOR_BAT_NATIVE_ADS_SRC_BAT_ADS_INTERNAL_FEDERATED_COVARIATES_AVERAGE_CLICKTHROUGH_RATE_H_
