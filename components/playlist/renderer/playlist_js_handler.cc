...
PlaylistJSHandler::~PlaylistJSHandler() = default;

// void PlaylistJSHandler::HiddenClassIdSelectors(
...
//       input, exceptions_,
//       base::BindOnce(&PlaylistJSHandler::OnHiddenClassIdSelectors,
//                      base::Unretained(this)));
// }

// bool PlaylistJSHandler::OnIsFirstParty(const std::string& url_string) {
...
void PlaylistJSHandler::AddJavaScriptObjectToFrame(
...
// void PlaylistJSHandler::InjectStylesheet(const std::string& stylesheet,
//                                                 int id) {
...
// void PlaylistJSHandler::UninjectStylesheet(int id) {
//   blink::WebLocalFrame* web_frame = render_frame_->GetWebFrame();
...
void PlaylistJSHandler::CreateWorkerObject(
    v8::Isolate* isolate,
    v8::Local<v8::Context> context) {
...
void PlaylistJSHandler::BindFunctionsToObject(
    v8::Isolate* isolate,
    v8::Local<v8::Object> javascript_object) {
  // BindFunctionToObject(
  //     isolate, javascript_object, "hiddenClassIdSelectors",
  //     base::BindRepeating(&PlaylistJSHandler::HiddenClassIdSelectors,
  //                         base::Unretained(this)));
  // BindFunctionToObject(
  //     isolate, javascript_object, "isFirstPartyUrl",
  //     base::BindRepeating(&PlaylistJSHandler::OnIsFirstParty,
  //                         base::Unretained(this)));
  // BindFunctionToObject(
  //     isolate, javascript_object, "injectStylesheet",
  //     base::BindRepeating(&PlaylistJSHandler::InjectStylesheet,
  //                         base::Unretained(this)));
  // BindFunctionToObject(
  //     isolate, javascript_object, "uninjectStylesheet",
  //     base::BindRepeating(&PlaylistJSHandler::UninjectStylesheet,
  //                         base::Unretained(this)));
}

template <typename Sig>
void PlaylistJSHandler::BindFunctionToObject(
    v8::Isolate* isolate,
    v8::Local<v8::Object> javascript_object,
...
bool PlaylistJSHandler::EnsureConnected() {
  ...
  //       base::BindOnce(&PlaylistJSHandler::OnRemoteDisconnect,
...
void PlaylistJSHandler::OnRemoteDisconnect() {
  // cosmetic_filters_resources_.reset();
  EnsureConnected();
}

bool PlaylistJSHandler::ProcessURL(
    const GURL& url,
  ...
  //       url_.spec(),
  //       base::BindOnce(&PlaylistJSHandler::OnUrlCosmeticResources,
...
// void PlaylistJSHandler::OnUrlCosmeticResources(
...
void PlaylistJSHandler::ApplyRules() {
  // blink::WebLocalFrame* web_frame = render_frame_->GetWebFrame();
...
void PlaylistJSHandler::CSSRulesRoutine(
...
// void PlaylistJSHandler::OnHiddenClassIdSelectors(base::Value result) {
//   if (generichide_) {
//     return;
//   }
...
void PlaylistJSHandler::ExecuteObservingBundleEntryPoint() {
  // blink::WebLocalFrame* web_frame = render_frame_->GetWebFrame();
  // DCHECK(web_frame);
